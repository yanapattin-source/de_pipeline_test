...
CREATE INDEX idx_fact_sensor ON warehouse.fact_sensor_reading(sensor_id);
CREATE INDEX idx_fact_dept ON warehouse.fact_sensor_reading(department_id);
CREATE INDEX idx_fact_product ON warehouse.fact_sensor_reading(product_id);
CREATE INDEX idx_fact_create_at ON warehouse.fact_sensor_reading(create_at);
